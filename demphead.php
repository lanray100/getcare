...
<div class="row">
            ...
            <a class="navbar-brand log" href="demployer.php" ><i style="color:rgb(128,255,0);">get</i><i style="color: rgb(0,64,128);">Caregiver</i></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                      <ul class="navbar-nav" >
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="modal" data-target="#job" href="#" style='color:black;'>Post a Job</a>
                        </li>
                        <li class="nav-item">
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <a class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['employer_fname']; ?></a>
                            <div class="dropdown-menu">
                                 <a class="dropdown-item" href="demployer2.php">Profile</a>
