                ...
                include ('userauth.php'); ?>
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            if (count($err_msg) == 0) {
                                    ...
                                    $regobj->registerCaregiver($lastname,$firstname,$username,$email,$pswd,
                                        $gender,$phone,$verify,$city,$stateid);
                 ...
                 <div class="container-fluid">
                               ...
                               <form method='post' action=" <?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="for1">
                                <p style="font-size: 40px;">Caregiver/Nurse Registration</p>
                                <p align="center">Get a full time or part time job today!</p>
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    <div class="form-group">
                                            ...
                                            ?>
                                    <p class="form-text"> International Passport or Driver License or National Identification </p>
                                            </div>
